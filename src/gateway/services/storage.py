...
class StorageService:
    ...
    def _parse_data_modes(self, hdd_node) -> list[dict[str, str]]:
            ...
            data_modes.append(
                {
                    ...
                    "occupancy_rate": child_text(data_mode, "occupancyRate"),
                }
            )

        return data_modes

    def _parse_encryption(self, hdd_node) -> dict[str, str]:
        ...
        return {
            "password_min_length": password_len.get("min", "") if password_len is not None else "",
            "password_max_length": password_len.get("max", "") if password_len is not None else "",
    ...
    def _parse_hdd(self, hdd_node) -> dict[str, Any]:
        return {
            ...
            "capacity_mb": child_text(hdd_node, "capacity"),
            "free_space_mb": child_text(hdd_node, "freeSpace"),
            "property": child_text(hdd_node, "property"),
            "group": child_text(hdd_node, "group"),
